...
public class ActionTestCollection {
    public   List<ActionTest> ActionSpisok = Arrays.asList(
            ...
            new ActionTest(2, ActionTest.TypeAction.ONOFF, "Капот", "out2=", "0", "1"),
            new ActionTest(3, ActionTest.TypeAction.ONOFF, "Дверь", "out3=", "0", "1"),
            ...
            new ActionTest(6, ActionTest.TypeAction.ONOFF, "КТС", "out6=", "0", "1"),
